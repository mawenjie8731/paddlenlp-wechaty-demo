...
更多使用PaddleNLP案例与Wechaty碰：客服、闲聊、对诗、写作、彩虹屁，起名、对联、码代码等你来尝试～来PaddleNLP中尽情探索吧[PaddleNLP/examples](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples)。
